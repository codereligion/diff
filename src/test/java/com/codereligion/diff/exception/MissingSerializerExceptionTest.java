...
public class MissingSerializerExceptionTest {
    ...
    @Test
    public void missingPropertySerializerShouldCreatePropertySpecificMessage() throws Exception {
    ...
    @Test
    public void missingMapKeySerializerShouldCreateMapKeySpecificMessage() throws Exception {
