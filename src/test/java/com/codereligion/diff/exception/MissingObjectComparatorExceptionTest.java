...
public class MissingObjectComparatorExceptionTest {
    ...
    @Test
    public void missingIterableComparatorFactoryMethodShouldCreateIterableSpecificMessage() throws Exception {
    ...
    @Test
    public void missingMapKeyComparatorFactoryMethodShouldCreateMapKeySpecificMessage() throws Exception {
